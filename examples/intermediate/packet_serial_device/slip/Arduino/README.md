The Arduino example that corresponds to this openFrameworks example can be found [here](https://github.com/bakercp/PacketSerial/tree/master/examples/PacketSerialReverseEchoSLIP).
