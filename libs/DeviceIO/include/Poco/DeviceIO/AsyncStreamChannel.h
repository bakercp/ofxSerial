...
#ifndef DeviceIO_AsyncStreamChannel_INCLUDED
#define DeviceIO_AsyncStreamChannel_INCLUDED
...
class DeviceIO_API AsyncStreamChannel: public AsyncChannel
	/// AsyncStreamChannel provides an AsyncChannel for I/O streams.
	///
	/// Usage Example:
...
#endif // DeviceIO_AsyncStreamChannel_INCLUDED
