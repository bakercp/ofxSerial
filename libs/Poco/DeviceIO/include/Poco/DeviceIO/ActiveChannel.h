...
// ActiveChannel.h
//
// $Id: //poco/Main/Data/include/Poco/ActiveChannel.h#1 $
//
// Library: Foundation
// Package: Foundation
...
#ifndef DeviceIO_ActiveChannel_INCLUDED
#define DeviceIO_ActiveChannel_INCLUDED
...
public:
	ActiveChannel(P& channel):
		read(this, &ActiveChannel::readImpl),
		write(this, &ActiveChannel::writeImpl),
		_channel(channel)
	{
	}
...
#endif // DeviceIO_ActiveChannel_INCLUDED
