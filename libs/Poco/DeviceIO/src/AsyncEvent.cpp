...
// AsyncEvent.cpp
//
// $Id: //poco/svn/Foundation/src/AsyncEvent.cpp#2 $
//
// Library: Foundation
// Package: AsyncIO
// Module:  AsyncEvent
...
AsyncEvent::AsyncEvent(AsyncCommand* pCommand, AsyncChannel* pChannel, EventKind what):
	_pCommand(pCommand),
	_pChannel(pChannel),
	_what(what)
{
...
AsyncEvent::AsyncEvent(const AsyncEvent& event):
...
AsyncEvent& AsyncEvent::operator = (const AsyncEvent& event)
{
	AsyncEvent tmp(event);
	swap(tmp);
	return *this;
}		


void AsyncEvent::swap(AsyncEvent& event)
{
